...
"""
<plugin key="pzem-016" name="PZEM-016 PZEM-014 energy meters" version="1.0" author="CreasolTech" externallink="https://github.com/CreasolTech/domoticz-pzem-016">
    <description>
        <h2>Domoticz plugin for PZEM-016 and PZEM-014 energy meters - Version 1.0</h2>
